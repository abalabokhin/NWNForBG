...
IF ~~ THEN BEGIN 6 // from: 1.1
  ...
  IF ~~ THEN DO ~DO ~SetGlobal("LeesQuest","GLOBAL",1)EscapeArea()~ UNSOLVED_JOURNAL ~Лииса согласилась вернуться в Маску Лунного Камня, где она сможет воссоединиться со своей сестрой Люс.~ EXIT
END
...
~ RandomNum(1,2)GlobalGT("LeesQuest","GLOBAL",0)!Global("LeesQuest","GLOBAL",9)~ THEN BEGIN 13 // from:
