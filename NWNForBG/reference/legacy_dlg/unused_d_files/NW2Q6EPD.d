...
~   GlobalLT("GolemCreated","MYAREA",2)~ THEN BEGIN 0 // from:
  ...
  IF ~  PartyHasItem("NWWAND5")Global("GolemCreated","MYAREA",0)~ THEN REPLY @2 GOTO 3
  IF ~  PartyHasItem("NWWAND5")Global("GolemCreated","MYAREA",1)~ THEN REPLY @2 GOTO 4
...
IF ~~ THEN BEGIN 1 // from: 1.1
  SAY @6
  IF ~  PartyHasItem("NWWAND5")~ THEN REPLY @2 GOTO 3
...
IF ~~ THEN BEGIN 2 // from: 2.2
  SAY @7
  IF ~  PartyHasItem("NWWAND5")~ THEN REPLY @2 GOTO 4
...
IF ~~ THEN BEGIN 3 // from: 1.3
  SAY @8
  IF ~~ THEN DO ~SetGlobal("GolemCreated","MYAREA",1)TakePartyItem("NWWAND5")DestroyItem("NWWAND5")~ EXIT
END

IF ~~ THEN BEGIN 4 // from: 1.4
  SAY @9
  IF ~~ THEN DO ~SetGlobal("GolemCreated","MYAREA",2)TakePartyItem("NWWAND5")DestroyItem("NWWAND5")~ EXIT
END
