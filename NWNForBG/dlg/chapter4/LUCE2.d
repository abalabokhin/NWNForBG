...
IF ~~ THEN BEGIN 10 // from: 6.3
  SAY @23
  IF ~~ THEN DO ~EraseJournalEntry(@107444)EraseJournalEntry(@107445)~ SOLVED_JOURNAL @107446 GOTO 2
END
...
IF ~~ THEN BEGIN 14 // from: 13.1
  SAY @32
  IF ~~ THEN DO ~SetGlobal("LuceJob","GLOBAL",3)GiveItemCreate("CLCKNW5",LastTalkedToBy,1,1,1)EraseJournalEntry(@107444)EraseJournalEntry(@107445)~ SOLVED_JOURNAL @107447 EXIT
END
