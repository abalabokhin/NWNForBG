...
IF ~~ THEN BEGIN 7 // from: 1.2
  SAY @19
  IF ~  OR(2)GlobalGT("NWFormosaQuest","GLOBAL",1)Dead("NWFORMOA")~ THEN REPLY @20 GOTO 15
  IF ~  GlobalLT("NWFormosaQuest","GLOBAL",2)!Dead("NWFORMOA")~ THEN REPLY @20 GOTO 26
  IF ~  OR(2)GlobalGT("NWFormosaQuest","GLOBAL",1)Dead("NWFORMOA")~ THEN REPLY @21 GOTO 16
  IF ~  GlobalLT("NWFormosaQuest","GLOBAL",2)!Dead("NWFORMOA")~ THEN REPLY @21 GOTO 27
...
IF ~~ THEN BEGIN 14 // from: 6.3
  ...
  IF ~~ THEN REPLY @6 GOTO 7
  IF ~~ THEN REPLY @7 GOTO 8
  IF ~  Global("RobberyAttempt","LOCALS",0)~ THEN REPLY @38 DO ~SetGlobal("RobberyAttempt","LOCALS",1)~ GOTO 9
  IF ~~ THEN REPLY @9 GOTO 10
END
...
IF ~~ THEN BEGIN 22 // from: 9.1
  SAY @46
  IF ~~ THEN DO ~GivePartyGold(268)SetGlobal("Robbed","LOCALS",1)IncrementGlobal("NWEvilNW1","GLOBAL",1)~ EXIT
END
...
IF ~~ THEN BEGIN 26 // from: 7.2
  ...
  IF ~  Gender(LastTalkedToBy(Myself),FEMALE)CheckStatGT(LastTalkedToBy(Myself),11,CHR)~ THEN REPLY @52 GOTO 29
  IF ~  Gender(LastTalkedToBy(Myself),FEMALE)CheckStatLT(LastTalkedToBy(Myself),12,CHR)~ THEN REPLY @52 GOTO 30
  IF ~  OR(2)GlobalGT("NWFormosaQuest","GLOBAL",1)Dead("NWFORMOA")~ THEN REPLY @21 GOTO 16
  IF ~  GlobalLT("NWFormosaQuest","GLOBAL",2)!Dead("NWFORMOA")~ THEN REPLY @21 GOTO 27
  IF ~~ THEN REPLY @22 GOTO 17
  IF ~~ THEN REPLY @9 GOTO 10
