...
IF ~~ THEN BEGIN 59 // from: 56.1
  SAY @110
  IF ~~ THEN DO ~SetGlobal("SharwynQuest","GLOBAL",4)AddexperienceParty(60000)AddXPObject("NWSHARWN",100000)TakePartyItem("Nwmisc44")DestroyItem("Nwmisc44")GiveItemCreate("NWBELTS1",Player1,1,1,1)~ EXIT
END
...
IF ~~ THEN BEGIN 121 // from: 117.1
  SAY @223
  IF ~~THEN DO ~SetGlobal("SharwynQuest2","GLOBAL",4)AddexperienceParty(60000)AddXPObject("NWSHARWN",100000)TakePartyItem("Nwmisc45")DestroyItem("Nwmisc45")
TakePartyItem("NWBELTS1")DestroyItem("NWBELTS1")GiveItemCreate("NWBELTS2",Player1,0,0,0)~ EXIT
END
...
AddexperienceParty(60000)AddXPObject("NWSHARWN",100000)TakePartyItem("Nwmisc45")DestroyItem("Nwmisc45")GiveItemCreate("NWBELTS2",Player1,1,1,1)~ EXIT
END
...
AddexperienceParty(60000)AddXPObject("NWSHARWN",150000)TakePartyItem("Nwmisc46")DestroyItem("Nwmisc46")TakePartyItem("NWBELTS2")DestroyItem("NWBELTS2")GiveItemCreate("NWBELTS3",Player1,0,0,0)~ EXIT
END
...
~  InParty(Myself)Global("NWNChapter","GLOBAL",4)Global("Chapter4Talk","LOCALS",0)!Dead("NWMORAG4")~ THEN BEGIN 184 // from:
  SAY @325
