...
IF ~~ THEN BEGIN 87 // from: 86.1
  SAY @161
  IF ~  PartyHasItem("NWAMUGR1")~ THEN REPLY @162 GOTO 88
  IF ~  !PartyHasItem("NWAMUGR1")~ THEN REPLY @162 GOTO 89
  IF ~  PartyHasItem("NWAMUGR1")~ THEN REPLY @163 GOTO 88
  IF ~  !PartyHasItem("NWAMUGR1")~ THEN REPLY @163 GOTO 89
END
...
~  InParty(Myself)Global("NWNChapter","GLOBAL",4)Global("Chapter4Talk","LOCALS",0)!Dead("NWMORAG4")~ THEN BEGIN 138 // from:
  SAY @258
