...
~Global("KickedOut","LOCALS",0)Global("NWSharwynEscape","GLOBAL",0)~ THEN BEGIN 0 // from:
  SAY @1
...
MoveGlobal("NW1012","NWSHARWN",[1141.652])~ EXIT
  IF ~  Global("NWNChapter","GLOBAL",2)~ THEN REPLY @6 DO ~SetGlobal("KickedOut","LOCALS",1)
MoveGlobal("NW2020","NWSHARWN",[945.348])~ EXIT
  IF ~  !Global("NWNChapter","GLOBAL",2)~ THEN REPLY @7 DO ~SetGlobal("KickedOut","LOCALS",1)~ EXIT
  IF ~  Global("NWNChapter","GLOBAL",2)~ THEN REPLY @7 DO ~SetGlobal("KickedOut","LOCALS",1)SetGlobal("NWSharwynOut","GLOBAL",1)~ EXIT
END
...
~Global("KickedOut","LOCALS",1)Global("NWSharwynEscape","GLOBAL",0)~ THEN BEGIN 2 // from:
  SAY @9
...
IF ~~ THEN BEGIN 3 // from: 2.1
  SAY @12
  IF ~~ THEN DO ~SetGlobal("NWSharwynOut","GLOBAL",0)SetGlobal("KickedOut","LOCALS",0)JoinParty()~ EXIT
END
...
IF ~~ THEN BEGIN 36 // from: 34.2
  SAY @30
  IF ~~ THEN DO ~SetGlobal("NWSharwynEscape","GLOBAL",0)SetGlobal("NWSharwynReleased","GLOBAL",2)JoinParty()~ EXIT
END
