...
IF ~~ THEN BEGIN 109 // from: 106.1
  SAY @198
  IF ~  PartyHasItem("RingTom1")~ THEN REPLY @199 GOTO 110
  IF ~  !PartyHasItem("RingTom1")~ THEN REPLY @199 GOTO 111
  IF ~  PartyHasItem("RingTom1")~ THEN REPLY @200 GOTO 112
  IF ~  !PartyHasItem("RingTom1")~ THEN REPLY @200 GOTO 113
END
...
~  InParty(Myself)Global("NWNChapter","GLOBAL",4)Global("Chapter4Talk","LOCALS",0)!Dead("MORAG4")~ THEN BEGIN 170 // from:
  SAY @299
