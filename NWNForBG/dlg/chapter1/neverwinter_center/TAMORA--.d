...
~  Gender(LastTalkedToBy(Myself),MALE)Global("TamoraTired","MYAREA",0)!Global("TamoraQuest","GLOBAL",1)!Global("TamoraQuest","GLOBAL",9)~ THEN BEGIN 0 // from:
...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  PartyHasItem("Oppermit")!IsGabber(Player1)~ THEN REPLY ~Вот пропуск.~ DO ~TakePartyItem("Oppermit")DestroyItem("Oppermit")~ GOTO 49
...
IF ~~ THEN BEGIN 10 // from: 5.4
  ...
  IF ~~ THEN DO ~SetGlobal("TamoraTired","MYAREA",1)SetGlobalTimer("TamoraTimer","LOCALS",2400)ClearAllActions()StartCutSceneMode()StartCutScene("Tamora")~ EXIT
END
...
~  Gender(LastTalkedToBy(Myself),MALE)Global("TamoraQuest","GLOBAL",1)Global("HoffHasMisc19","GLOBAL",0)~ THEN BEGIN 33 // from:
  ...
  IF ~Global("TamoraQuest","GLOBAL",0)~ THEN REPLY ~О каком деле речь? У вас проблемы?~ GOTO 35
...
IF ~~ THEN BEGIN 45 // from: 44.1
  ...
  IF ~~ THEN DO ~SetGlobal("TamoraQuest","GLOBAL",2)AddexperienceParty(30000)TakePartyItem("Nwmisc19")~ EXIT
END
...
IF ~~ THEN BEGIN 46 // from: 44.2
  ...
  IF ~~ THEN DO ~SetGlobal("TamoraQuest","GLOBAL",2)AddexperienceParty(50000)TakePartyItem("Nwmisc19")~ EXIT
END
