...
AddexperienceParty(60000)AddXPObject("NWTOMI",100000)TakePartyItem("Nwmisc47")DestroyItem("Nwmisc47")GiveItemCreate("NWRINGT1",Player1,1,0,0)~ EXIT
END
...
IF ~~ THEN BEGIN 110 // from: 109.1
  SAY @201
  IF ~~THEN DO ~SetGlobal("TomiQuest2","GLOBAL",4)AddexperienceParty(60000)AddXPObject("NWTOMI",100000)TakePartyItem("Nwmisc48")DestroyItem("Nwmisc48")
TakePartyItem("NWRINGT1")DestroyItem("NWRINGT1")GiveItemCreate("NWRINGT2",Player1,2,0,0)~ EXIT
END

IF ~~ THEN BEGIN 111 // from: 109.2
  SAY @202
  IF ~~ THEN DO ~SetGlobal("TomiQuest2","GLOBAL",4)
AddexperienceParty(60000)AddXPObject("NWTOMI",100000)TakePartyItem("Nwmisc48")DestroyItem("Nwmisc48")GiveItemCreate("NWRINGT2",Player1,2,0,0)~ EXIT
END
...
AddexperienceParty(60000)AddXPObject("NWTOMI",150000)TakePartyItem("Nwmisc49")DestroyItem("Nwmisc49")TakePartyItem("NWRINGT2")DestroyItem("NWRINGT2")GiveItemCreate("NWRINGT3",Player1,3,0,0)~ EXIT
END
...
~  InParty(Myself)Global("NWNChapter","GLOBAL",4)Global("Chapter4Talk","LOCALS",0)!Dead("NWMORAG4")~ THEN BEGIN 170 // from:
  SAY @299
