...
IF ~~ THEN BEGIN 20 // from: 16.1
  SAY @36
  IF ~~ THEN DO ~SetGlobal("NyatarQuest","GLOBAL",2)GiveItemCreate("NWNYATKY",LastTalkedToBy,1,0,0)GiveItemCreate("NWNYATSL",LastTalkedToBy,1,0,0)~ UNSOLVED_JOURNAL @92603 EXIT
END

IF ~~ THEN BEGIN 21 // from: 16.2
  SAY @38
  IF ~~ THEN DO ~SetGlobal("NyatarQuest","GLOBAL",2)GiveItemCreate("NWNYATKY",LastTalkedToBy,1,0,0)GiveItemCreate("NWNYATSL",LastTalkedToBy,1,0,0)
...
IF ~~ THEN BEGIN 22 // from: 17.1
  SAY @36
  IF ~~ THEN DO ~SetGlobal("NyatarQuest","GLOBAL",1)GiveItemCreate("NWNYATKY",LastTalkedToBy,1,0,0)GiveItemCreate("NWNYATSL",LastTalkedToBy,1,0,0)~ EXIT
END

IF ~~ THEN BEGIN 23 // from: 17.2
  SAY @38
  IF ~~ THEN DO ~SetGlobal("NyatarQuest","GLOBAL",1)GiveItemCreate("NWNYATKY",LastTalkedToBy,1,0,0)GiveItemCreate("NWNYATSL",LastTalkedToBy,1,0,0)
...
IF ~~ THEN BEGIN 30 // from: 25.2
  SAY @51
  IF ~~ THEN DO ~SetGlobal("NyatarQuest","GLOBAL",3)AddexperienceParty(120000)GiveItem("NWNYATPZ",LastTalkedToBy)EraseJournalEntry(@92603)EraseJournalEntry(@92604)~ SOLVED_JOURNAL @92651 EXIT
END
...
IF ~~ THEN BEGIN 34 // from: 29.2
  SAY @58
  IF ~~ THEN DO ~SetGlobal("NyatarQuest","GLOBAL",3)AddexperienceParty(100000)GiveItem("NWNYATPZ",LastTalkedToBy)EraseJournalEntry(@92603)EraseJournalEntry(@92604)~ SOLVED_JOURNAL @92656 EXIT
END
