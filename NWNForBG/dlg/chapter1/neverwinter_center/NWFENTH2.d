...
IF ~~ THEN BEGIN 2 // 1.1
  SAY @5
  IF ~  See("NWDESTHR")~ THEN EXTERN ~NWDESTH2~ 1 // Правда, Фентик, сейчас не время для таких разговоров. Другие не поймут этого так, как понимаешь ты.
  IF ~  !See("NWDESTHR")~ THEN GOTO 8
END
