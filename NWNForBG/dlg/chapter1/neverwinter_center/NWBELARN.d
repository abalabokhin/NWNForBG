...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  OR(2)CheckStatGT(LastTalkedToBy(Myself),17,STR)Class(LastTalkedToBy(Myself),THIEF_ALL)Global("Robbed","LOCALS",0)~ THEN REPLY @7 GOTO 6
  IF ~  CheckStatLT(LastTalkedToBy(Myself),18,STR)!Class(LastTalkedToBy(Myself),THIEF_ALL)Global("Robbed","LOCALS",0)~ THEN REPLY @7 GOTO 7
  IF ~~ THEN REPLY @2 GOTO 2
END
...
IF ~~ THEN BEGIN 12 // from: 6.1
  ...
  IF ~~ THEN REPLY @32 DO ~SetGlobal("Robbed","LOCALS",1)~ GOTO 25
END
...
IF ~~ THEN BEGIN 30 // from: 16.1
  SAY @41
  IF ~  CheckStatGT(LastTalkedToBy(Myself),10,CHR)~ THEN REPLY @42 GOTO 32
  IF ~  CheckStatLT(LastTalkedToBy(Myself),11,CHR)~ THEN REPLY @42 GOTO 33
  IF ~~ THEN REPLY @22 GOTO 13
  IF ~~ THEN REPLY @23 GOTO 14
  IF ~~ THEN REPLY @24 GOTO 15
  IF ~  Global("NWPeninsulaDone","GLOBAL",0)~ THEN REPLY @26 GOTO 17
