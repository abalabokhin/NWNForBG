...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  OR(4)PartyHasItem("Crewtd1")PartyHasItem("Crewtd2")PartyHasItem("Crewtd3")PartyHasItem("Crewtd4")~ THEN REPLY @8 GOTO 5
END
...
IF ~~ THEN BEGIN 5 // from: 1.4
  SAY @12
  IF ~  PartyHasItem("Crewtd1")~ THEN REPLY @13 GOTO 7
  IF ~  PartyHasItem("Crewtd2")~ THEN REPLY @14 DO ~SetGlobal("Brainworm","GLOBAL",1)~ GOTO 8
  IF ~  PartyHasItem("Crewtd3")~ THEN REPLY @15 GOTO 9
  IF ~  PartyHasItem("Crewtd4")~ THEN REPLY @16 GOTO 10
END
...
IF ~~ THEN BEGIN 12 // from: 7.2
  SAY @26
  IF ~  PartyHasItem("Crewtd1")~ THEN REPLY @27 GOTO 14
  IF ~  PartyHasItem("Crewtd2")~ THEN REPLY @27 GOTO 63
  IF ~  PartyHasItem("Crewtd3")~ THEN REPLY @27 GOTO 64
  IF ~  PartyHasItem("Crewtd4")~ THEN REPLY @27 GOTO 65
  IF ~  PartyHasItem("Crewtd1")~ THEN REPLY @28 GOTO 15
  IF ~  PartyHasItem("Crewtd2")~ THEN REPLY @28 GOTO 66
  IF ~  PartyHasItem("Crewtd3")~ THEN REPLY @28 GOTO 67
  IF ~  PartyHasItem("Crewtd4")~ THEN REPLY @28 GOTO 68
END
...
~  Global("NWNChapter","GLOBAL",1)Global("WtDeepCreature","GLOBAL",0)IsGabber(Player1)~ THEN BEGIN 49 // from:
  ...
  IF ~  OR(4)PartyHasItem("Crewtd1")PartyHasItem("Crewtd2")PartyHasItem("Crewtd3")PartyHasItem("Crewtd4")~ THEN REPLY @8 GOTO 5
  IF ~  OR(3)PartyHasItem("AnonymL1")PartyHasItem("AnonymL2")PartyHasItem("AnonymL3")~ THEN REPLY @100 GOTO 51
  IF ~~ THEN REPLY @101 DO ~StartStore("Aribeth1",LastTalkedToBy(Myself))~ EXIT
...
~  Global("NWNChapter","GLOBAL",1)Global("WtDeepCreature","GLOBAL",3)IsGabber(Player1)~ THEN BEGIN 55 // from:
  SAY @108
  IF ~~ THEN REPLY @99 GOTO 50
  IF ~  OR(4)PartyHasItem("Crewtd1")PartyHasItem("Crewtd2")PartyHasItem("Crewtd3")PartyHasItem("Crewtd4")~ THEN REPLY @109 GOTO 56
  IF ~  OR(3)PartyHasItem("AnonymL1")PartyHasItem("AnonymL2")PartyHasItem("AnonymL3")~ THEN REPLY @100 GOTO 51
  IF ~~ THEN REPLY @101 DO ~StartStore("Aribeth1",LastTalkedToBy(Myself))~ EXIT
  IF ~~ THEN REPLY @102 GOTO 52
  IF ~~ THEN REPLY @59 GOTO 35
...
IF ~~ THEN BEGIN 56 // from: 55.2
  SAY @110
  IF ~  PartyHasItem("Crewtd1")~ THEN REPLY @13 GOTO 7
  IF ~  PartyHasItem("Crewtd2")~ THEN REPLY @14 GOTO 8
  IF ~  PartyHasItem("Crewtd3")~ THEN REPLY @15 GOTO 9
  IF ~  PartyHasItem("Crewtd4")~ THEN REPLY @16 GOTO 10
END
