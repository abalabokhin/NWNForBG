...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  PartyHasItem("NWOPPERT")!IsGabber(Player1)~ THEN REPLY @7 GOTO 47
...
IF ~~ THEN BEGIN 40 // from: 10.1
  SAY @40
  IF ~~ THEN DO ~TakePartyItem("NWOPPERT")DestroyItem("NWOPPERT")SetGlobal("TanitTired","MYAREA",3)~ EXIT
END

IF ~~ THEN BEGIN 41 // from: 10.2
  SAY @41
  IF ~~ THEN DO ~TakePartyItem("NWOPPERT")DestroyItem("NWOPPERT")SetGlobal("TanitTired","MYAREA",1)~ EXIT
END
