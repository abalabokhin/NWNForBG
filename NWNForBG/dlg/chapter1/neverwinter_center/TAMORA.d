...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  PartyHasItem("Oppermit")!IsGabber(Player1)~ THEN REPLY @7 GOTO 49
...
IF ~~ THEN BEGIN 22 // from: 15.6
  SAY @54
  IF ~  Dead("Hoff")~ THEN REPLY @55 GOTO 28
...
IF ~~ THEN BEGIN 36 // from: 33.4
  SAY @76
  IF ~  Dead("Hoff")PartyHasItem("Nwmisc19")~ THEN REPLY @77 GOTO 37
  IF ~  Dead("Hoff")!PartyHasItem("Nwmisc19")~ THEN REPLY @78 GOTO 38
  IF ~  Global("HoffScared","GLOBAL",1)!Dead("Hoff")PartyHasItem("Nwmisc19")~ THEN REPLY @79 GOTO 39
  IF ~  Global("HoffScared","GLOBAL",1)!Dead("Hoff")!PartyHasItem("Nwmisc19")~ THEN REPLY @80 GOTO 40
...
~  Gender(LastTalkedToBy(Myself),MALE)Global("TamoraQuest","GLOBAL",1)Global("HoffHasMisc19","GLOBAL",1)~ THEN BEGIN 44 // from:
  SAY @86
  IF ~  PartyHasItem("Nwmisc19")!Dead("Hoff")~ THEN REPLY @87 GOTO 45
  IF ~  PartyHasItem("Nwmisc19")Dead("Hoff")~ THEN REPLY @88 GOTO 46
