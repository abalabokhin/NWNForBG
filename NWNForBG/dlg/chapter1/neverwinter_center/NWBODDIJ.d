...
IF ~~ THEN BEGIN 85 // from: 84.1
  SAY @155
  IF ~  PartyHasItem("NWRINGB1")~ THEN REPLY @156 GOTO 88
  IF ~  !PartyHasItem("NWRINGB1")~ THEN REPLY @156 GOTO 90
  IF ~  PartyHasItem("NWRINGB1")~ THEN REPLY @157 GOTO 88
  IF ~  !PartyHasItem("NWRINGB1")~ THEN REPLY @157 GOTO 90
END
...
~  InParty(Myself)Global("NWNChapter","GLOBAL",4)Global("Chapter4Talk","LOCALS",0)!Dead("NWMORAG4")~ THEN BEGIN 148 // from:
  SAY @259
