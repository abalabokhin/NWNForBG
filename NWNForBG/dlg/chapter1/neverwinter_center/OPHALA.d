...
IF ~~ THEN BEGIN 17 // from: 13.1
  SAY @35
  IF ~  PartyHasItem("OleffLet")~ THEN REPLY @36 GOTO 23
...
~  !NumTimesTalkedTo(0)IsGabber(Player1)~ THEN BEGIN 26 // from:
  ...
  IF ~  PartyHasItem("OleffLet")~ THEN REPLY @46 GOTO 23
...
IF ~~ THEN BEGIN 27 // from: 26.1
  SAY @49
  IF ~  PartyHasItem("Nwmisc12")OR(2)!PartyHasItem("Nwmisc13")!PartyHasItem("Nwmisc14")GlobalLT("OphalaMisc","LOCALS",2)!Dead("Androd")~ THEN REPLY @50 GOTO 30
  IF ~  PartyHasItem("Nwmisc12")OR(2)!PartyHasItem("Nwmisc13")!PartyHasItem("Nwmisc14")GlobalLT("OphalaMisc","LOCALS",2)Dead("Androd")~ THEN REPLY @50 GOTO 31
  ...
  IF ~  PartyHasItem("Nwmisc13")OR(2)!PartyHasItem("Nwmisc12")!PartyHasItem("Nwmisc14")GlobalLT("OphalaMisc","LOCALS",2)!Dead("Thoms")~ THEN REPLY @51 GOTO 33
  IF ~  PartyHasItem("Nwmisc13")OR(2)!PartyHasItem("Nwmisc12")!PartyHasItem("Nwmisc14")GlobalLT("OphalaMisc","LOCALS",2)Dead("Thoms")~ THEN REPLY @51 GOTO 34
  ...
  IF ~  PartyHasItem("Nwmisc12")PartyHasItem("Nwmisc13")PartyHasItem("Nwmisc14")!Dead("Androd")!Dead("Thoms")~ THEN REPLY @53 GOTO 38
  IF ~  PartyHasItem("Nwmisc12")PartyHasItem("Nwmisc13")PartyHasItem("Nwmisc14")OR(2)Dead("Androd")Dead("Thoms")~ THEN REPLY @53 GOTO 39
