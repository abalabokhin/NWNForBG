...
~  Global("Overdrink","MYAREA",0)Global("NWNDocksDone","GLOBAL",0)RandomNum(2,1)!HasItemEquiped("NWUNIFOM",LastTalkedToBy(Myself))~ THEN BEGIN 0 // from:
  SAY @0
...
~  Global("Overdrink","MYAREA",0)Global("NWNDocksDone","GLOBAL",0)RandomNum(2,2)!HasItemEquiped("NWUNIFOM",LastTalkedToBy(Myself))~ THEN BEGIN 19 // from:
  SAY @35
  IF ~~ THEN REPLY @1 GOTO 1
  IF ~~ THEN REPLY @2 GOTO 2
  IF ~~ THEN REPLY @3 GOTO 3
...
~  Global("Overdrink","MYAREA",0)Global("NWNDocksDone","GLOBAL",0)HasItemEquiped("NWUNIFOM",LastTalkedToBy(Myself))~ THEN BEGIN 20 // from:
  SAY @36
