...
~  Global("NWNDocksDone","GLOBAL",0)~ THEN BEGIN 0 // from:
  SAY @0
  IF ~~ THEN REPLY @1 DO ~StartStore("Auction",LastTalkedToBy)~ EXIT
...
IF ~~ THEN BEGIN 1 // from: 0.2
  ...
  IF ~  Global("Weapon","LOCALS",1)!HasItem("AxeAuc",Myself)HasItem("SwordAuc",Myself)HasItem("BlunAuc",Myself)~ THEN REPLY @6 GOTO 6
  IF ~  Global("Weapon","LOCALS",1)HasItem("AxeAuc",Myself)!HasItem("SwordAuc",Myself)HasItem("BlunAuc",Myself)~ THEN REPLY @6 GOTO 7
  IF ~  Global("Weapon","LOCALS",1)HasItem("AxeAuc",Myself)HasItem("SwordAuc",Myself)!HasItem("BlunAuc",Myself)~ THEN REPLY @6 GOTO 8
  IF ~  Global("Weapon","LOCALS",2)HasItem("AxeAuc",Myself)~ THEN REPLY @6 GOTO 9
  IF ~  Global("Weapon","LOCALS",2)HasItem("SwordAuc",Myself)~ THEN REPLY @6 GOTO 10
  IF ~  Global("Weapon","LOCALS",2)HasItem("BlunAuc",Myself)~ THEN REPLY @6 GOTO 11
  IF ~  Global("Armor","LOCALS",0)~ THEN REPLY @7 GOTO 12
  IF ~  Global("Armor","LOCALS",1)!HasItem("PlatAuc",Myself)HasItem("ShldAuc",Myself)HasItem("LeatAuc",Myself)~ THEN REPLY @7 GOTO 13
  IF ~  Global("Armor","LOCALS",1)HasItem("PlatAuc",Myself)!HasItem("ShldAuc",Myself)HasItem("LeatAuc",Myself)~ THEN REPLY @7 GOTO 14
  IF ~  Global("Armor","LOCALS",1)HasItem("PlatAuc",Myself)HasItem("ShldAuc",Myself)!HasItem("LeatAuc",Myself)~ THEN REPLY @7 GOTO 15
  IF ~  Global("Armor","LOCALS",2)HasItem("PlatAuc",Myself)~ THEN REPLY @7 GOTO 16
  IF ~  Global("Armor","LOCALS",2)HasItem("ShldAuc",Myself)~ THEN REPLY @7 GOTO 17
  IF ~  Global("Armor","LOCALS",2)HasItem("LeatAuc",Myself)~ THEN REPLY @7 GOTO 18
  IF ~  HasItem("ClckAuc",Myself)HasItem("BeltAuc",Myself)~ THEN REPLY @8 GOTO 19
  IF ~  HasItem("ClckAuc",Myself)!HasItem("BeltAuc",Myself)~ THEN REPLY @8 GOTO 20
  IF ~  !HasItem("ClckAuc",Myself)HasItem("BeltAuc",Myself)~ THEN REPLY @8 GOTO 21
  IF ~~ THEN REPLY @4 GOTO 4
END
...
IF ~~ THEN BEGIN 5 // from: 1.1
  ...
  IF ~  Global("Armor","LOCALS",1)!HasItem("PlatAuc",Myself)HasItem("ShldAuc",Myself)HasItem("LeatAuc",Myself)~ THEN REPLY @16 GOTO 13
  IF ~  Global("Armor","LOCALS",1)HasItem("PlatAuc",Myself)!HasItem("ShldAuc",Myself)HasItem("LeatAuc",Myself)~ THEN REPLY @16 GOTO 14
  IF ~  Global("Armor","LOCALS",1)HasItem("PlatAuc",Myself)HasItem("ShldAuc",Myself)!HasItem("LeatAuc",Myself)~ THEN REPLY @16 GOTO 15
  IF ~  Global("Armor","LOCALS",2)HasItem("PlatAuc",Myself)~ THEN REPLY @16 GOTO 16
  IF ~  Global("Armor","LOCALS",2)HasItem("ShldAuc",Myself)~ THEN REPLY @16 GOTO 17
  IF ~  Global("Armor","LOCALS",2)HasItem("LeatAuc",Myself)~ THEN REPLY @16 GOTO 18
  IF ~  HasItem("ClckAuc",Myself)HasItem("BeltAuc",Myself)~ THEN REPLY @17 GOTO 19
  IF ~  HasItem("ClckAuc",Myself)!HasItem("BeltAuc",Myself)~ THEN REPLY @17 GOTO 20
  IF ~  !HasItem("ClckAuc",Myself)HasItem("BeltAuc",Myself)~ THEN REPLY @17 GOTO 21
  IF ~~ THEN REPLY @1 DO ~StartStore("Auction",LastTalkedToBy)~ EXIT
  IF ~~ THEN REPLY @4 GOTO 4
END
...
IF ~~ THEN BEGIN 12 // from: 1.8
  ...
  IF ~  Global("Weapon","LOCALS",1)!HasItem("AxeAuc",Myself)HasItem("SwordAuc",Myself)HasItem("BlunAuc",Myself)~ THEN REPLY @27 GOTO 6
  IF ~  Global("Weapon","LOCALS",1)HasItem("AxeAuc",Myself)!HasItem("SwordAuc",Myself)HasItem("BlunAuc",Myself)~ THEN REPLY @27 GOTO 7
  IF ~  Global("Weapon","LOCALS",1)HasItem("AxeAuc",Myself)HasItem("SwordAuc",Myself)!HasItem("BlunAuc",Myself)~ THEN REPLY @27 GOTO 8
  IF ~  Global("Weapon","LOCALS",2)HasItem("AxeAuc",Myself)~ THEN REPLY @27 GOTO 9
  IF ~  Global("Weapon","LOCALS",2)HasItem("SwordAuc",Myself)~ THEN REPLY @27 GOTO 10
  IF ~  Global("Weapon","LOCALS",2)HasItem("BlunAuc",Myself)~ THEN REPLY @27 GOTO 11
  IF ~  HasItem("ClckAuc",Myself)HasItem("BeltAuc",Myself)~ THEN REPLY @17 GOTO 19
  IF ~  HasItem("ClckAuc",Myself)!HasItem("BeltAuc",Myself)~ THEN REPLY @17 GOTO 20
  IF ~  !HasItem("ClckAuc",Myself)HasItem("BeltAuc",Myself)~ THEN REPLY @17 GOTO 21
  IF ~~ THEN REPLY @1 DO ~StartStore("Auction",LastTalkedToBy)~ EXIT
