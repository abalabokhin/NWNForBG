...
~  !Dead("NWCREWT2")!Allegiance(Myself,ENEMY)Global("MindFlayerInMe","LOCALS",0)~ THEN BEGIN 0 // from:
  SAY @0
...
~  Dead("NWCREWT2")Global("MindFlayerInMe","LOCALS",0)~ THEN BEGIN 3 // from:
  SAY @5
  IF ~~ THEN GOTO 4
END
...
~  !Dead("NWCREWT2")Allegiance(Myself,ENEMY)RandomNum(3,1)Global("MindFlayerInMe","LOCALS",1)~ THEN BEGIN 5 // from:
  SAY @7
...
~  !Dead("NWCREWT2")Allegiance(Myself,ENEMY)RandomNum(3,2)Global("MindFlayerInMe","LOCALS",1)~ THEN BEGIN 6 // from:
  SAY @8
  IF ~~ THEN DO ~AttackOneRound(LastTalkedToBy(Myself))~ EXIT
END
...
~  !Dead("NWCREWT2")Allegiance(Myself,ENEMY)RandomNum(3,3)Global("MindFlayerInMe","LOCALS",1)~ THEN BEGIN 7 // from:
  SAY @9
  IF ~~ THEN DO ~AttackOneRound(LastTalkedToBy(Myself))~ EXIT
END
