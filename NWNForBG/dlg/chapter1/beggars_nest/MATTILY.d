...
IF ~~ THEN BEGIN 2 // from: 0.2
  ...
  IF ~  Global("HectorFollow","GLOBAL",1)See("Hector")~ THEN REPLY @5 GOTO 6
  IF ~  Dead("Hector")~ THEN REPLY @6 GOTO 7
  IF ~  !Dead("Hector")!See("Hector")~ THEN REPLY @6 GOTO 11
  IF ~  !Dead("Hector")See("Hector")~ THEN REPLY @6 GOTO 12
...
IF ~~ THEN BEGIN 9 // from: ALDO 19
  SAY @14
  IF ~  !See("Hector")~ THEN REPLY @15 GOTO 13
  IF ~  See("Hector")~ THEN REPLY @15 GOTO 14
