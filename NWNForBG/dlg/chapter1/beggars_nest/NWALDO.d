...
IF ~~ THEN BEGIN 2 // from: 0.2
  SAY @9
  IF ~~ THEN EXTERN ~NWHECTOR~ 2 // Я старался, босс! Но нигде нет никаких частей. Клянусь!
END
...
IF ~~ THEN BEGIN 19 // from: NWMATTIY 3.1
  SAY @37
  IF ~~ THEN EXTERN ~NWMATTIY~ 9 // Хватит, Альдо! Мне уже надоело ждать колесо от повозки на улице, кишащей зомби!
END
