...
IF ~~ THEN BEGIN 6 // from: 1.2
  SAY @15
  IF ~  !Dead("NWDRAWL")Global("KnowBandit","GLOBAL",1)~ THEN REPLY @16 GOTO 14
  IF ~  Dead("NWDRAWL")Global("KnowBandit","GLOBAL",1)~ THEN REPLY @16 GOTO 47
...
IF ~~ THEN BEGIN 42// from: 39.1
  SAY @67
  IF ~~ THEN DO ~SetGlobal("HarbenQuest","GLOBAL",2)AddexperienceParty(40000)GiveGoldForce(800)GiveGoldForce(200)GiveItemCreate("NWHARBIM",LastTalkedToBy,1,1,1)EraseJournalEntry(@95176)EraseJournalEntry(@95191)~ SOLVED_JOURNAL @95309 EXIT
END
...
IF ~~ THEN BEGIN 44// from: 39.3
  SAY @70
  IF ~~ THEN DO ~SetGlobal("HarbenQuest","GLOBAL",2)AddexperienceParty(40000)GiveGoldForce(800)GiveItemCreate("NWHARBIM",LastTalkedToBy,1,1,1)EraseJournalEntry(@95176)EraseJournalEntry(@95191)~ SOLVED_JOURNAL @95309 EXIT
END
