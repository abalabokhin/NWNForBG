...
IF ~~ THEN BEGIN 12 // from: 7.2
  ...
  IF ~  PartyHasItem("NWMARCUJ")CheckStatGT(LastTalkedToBy(Myself),12,CHR)~ THEN REPLY @27 DO ~TakePartyItem("NWMARCUJ")DestroyItem("NWMARCUJ")AddexperienceParty(20000)SetGlobal("Journal","LOCALS",1)~ GOTO 16
  IF ~  PartyHasItem("NWMARCUJ")CheckStatLT(LastTalkedToBy(Myself),13,CHR)~ THEN REPLY @27 GOTO 17
  IF ~  PartyHasItem("NWMARCUS")~ THEN REPLY @28 GOTO 18
...
IF ~~ THEN BEGIN 14 // from: 12.1
  SAY @32
  IF ~  OR(2)PartyHasItem("NWMARCUJ")PartyHasItem("NWMARCUS")~ THEN REPLY @33 GOTO 21
  IF ~  OR(2)PartyHasItem("NWMARCUJ")PartyHasItem("NWMARCUS")~ THEN REPLY @34 GOTO 22
  IF ~~ THEN REPLY @30 GOTO 20
END
...
IF ~~ THEN BEGIN 16 // from: 12.3
  SAY @36
  IF ~  PartyHasItem("NWMARCUS")~ THEN REPLY @37 GOTO 18
...
IF ~~ THEN BEGIN 21 // from: 14.1
  SAY @45
  IF ~  PartyHasItem("NWMARCUS")~ THEN REPLY @37 GOTO 18
  IF ~  PartyHasItem("NWMARCUJ")~ THEN REPLY @46 GOTO 28
  IF ~~ THEN REPLY @47 GOTO 26
END

IF ~~ THEN BEGIN 22 // from: 14.2
  SAY @48
  IF ~  PartyHasItem("NWMARCUJ")~ THEN REPLY @49 GOTO 28
  IF ~  PartyHasItem("NWMARCUJ")~ THEN REPLY @50 GOTO 27
  IF ~  PartyHasItem("NWMARCUS")~ THEN REPLY @51 GOTO 25
  IF ~  PartyHasItem("NWMARCUS")~ THEN REPLY @52 GOTO 24
  IF ~~ THEN REPLY @47 GOTO 26
END
...
IF ~~ THEN BEGIN 25 // from: 18.2 22.3
  SAY @57
  IF ~~ THEN DO ~TakePartyItem("NWMARCUS")DestroyItem("NWMARCUS")AddexperienceParty(50000)SetGlobal("Staff","LOCALS",1)~ EXIT
END
...
IF ~~ THEN BEGIN 28 // from: 21.1
  SAY @62
  IF ~~ THEN DO ~TakePartyItem("NWMARCUJ")DestroyItem("NWMARCUJ")AddexperienceParty(20000)SetGlobal("Journal","LOCALS",1)~ EXIT
END

IF ~~ THEN BEGIN 29 // from: 24.1
  SAY @63
  IF ~~ THEN DO ~TakePartyItem("NWMARCUS")DestroyItem("NWMARCUS")GiveGoldForce(600)AddexperienceParty(20000)SetGlobal("Staff","LOCALS",2)~ EXIT
END
...
IF ~~ THEN BEGIN 31 // from: 27.1
  SAY @63
  IF ~~ THEN DO ~TakePartyItem("NWMARCUJ")DestroyItem("NWMARCUJ")GiveGoldForce(400)SetGlobal("Journal","LOCALS",2)~ EXIT
END
