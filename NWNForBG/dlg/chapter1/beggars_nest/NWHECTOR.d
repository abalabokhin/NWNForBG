...
~  NumTimesTalkedTo(0)Global("NWHectorFollow","GLOBAL",0)~ THEN BEGIN 0 // from:
  SAY @0
...
IF ~~ THEN BEGIN 1 // from: 0.1
  SAY @4
  IF ~  GlobalGT("NWAldoQuest","GLOBAL",0)~ THEN REPLY @5 GOTO 4
...
IF ~~ THEN BEGIN 3 // from: 1.3
  SAY @9
  IF ~~ THEN DO ~SetGlobal("NWKnowHector","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN 4 // from: 1.1
  SAY @10
  IF ~  Global("NWAldoQuest","GLOBAL",0)~ THEN REPLY @11 GOTO 7
...
IF ~~ THEN BEGIN 7 // from: 4.1
  SAY @17
  IF ~~ THEN DO ~SetGlobal("NWHectorFollow","GLOBAL",1)~ EXIT
END
...
~  !NumTimesTalkedTo(0)Global("NWHectorFollow","GLOBAL",0)~ THEN BEGIN 9 // from:
  SAY @19
...
~  GlobalGT("NWHectorFollow","GLOBAL",0)~ THEN BEGIN 11 // from:
  SAY @22
  IF ~~ THEN REPLY @20 GOTO 10
