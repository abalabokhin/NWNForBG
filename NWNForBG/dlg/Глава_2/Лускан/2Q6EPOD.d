...
~   GlobaLT("GolemCreated","MYAREA",2)~ THEN BEGIN 0 // from:
  ...
  IF ~  Globa("GolemCreated","MYAREA",0)~ THEN REPLY ~Рассмотреть углубления.~ GOTO 1
  IF ~  Globa("GolemCreated","MYAREA",1)~ THEN REPLY ~Рассмотреть углубления.~ GOTO 2
  IF ~  PartyHasItem("Wandnw5")Globa("GolemCreated","MYAREA",0)~ THEN REPLY ~Вставить жезл управления големами в углубление.~ GOTO 3
  IF ~  PartyHasItem("Wandnw5")Globa("GolemCreated","MYAREA",1)~ THEN REPLY ~Вставить жезл управления големами в углубление.~ GOTO 4
  IF ~  PartyHasItem("Wandnw6")Globa("GolemCreated","MYAREA",0)~ THEN REPLY ~Вставить жезл производства големов в углубление.~ GOTO 5
  IF ~  PartyHasItem("Wandnw6")Globa("GolemCreated","MYAREA",1)~ THEN REPLY ~Вставить жезл производства големов в углубление.~ GOTO 6
