...
IF ~~ THEN BEGIN 1 // from: 0.1
  SAY ~Вы стражник? Хотите произвести на меня впечатление? Что вы можете сделать? Вы не можете посадить чуму под замок. Вы не можете объяснить, почему это происходит. Мой ребенок... мое прекрасное дитя... погибла у меня на глазах. И мне оставалось только плакать. Ее у меня забрали... она умерла... Не думаю, что мне так уж нужен стражник.~
  IF ~~ THEN GOTO 5
END
