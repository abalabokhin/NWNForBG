...
IF ~~ THEN BEGIN 35 // from:
  SAY @61
  IF ~~ THEN EXTERN ~KARLATNW~ 27
END

IF ~~ THEN BEGIN 36 // from:
  SAY @62
  IF ~~ THEN REPLY @63 EXTERN ~QUINTNW2~ 24
  IF ~~ THEN REPLY @64 EXTERN ~KARLATNW~ 33
  IF ~~ THEN REPLY @65 GOTO 37
END

IF ~~ THEN BEGIN 37 // from: 36.2
  SAY @66
  IF ~  PartyHasItem("BelialT")
...
IF ~~ THEN BEGIN 40 // from:
  SAY @71
  IF ~~ THEN EXTERN ~KARLATNW~ 28
END

IF ~~ THEN BEGIN 41 // from:
  SAY @72
  IF ~~ THEN EXTERN ~QUINTNW2~ 28
END
...
ClearAllActions()
StartCutSceneMode()
StartCutScene("Court3")
~ EXIT
END

IF ~~ THEN BEGIN 49 // from: 47.0 46.0 45.0 44.0
  SAY @87
  IF ~~ THEN EXTERN ~QUINTNW2~ 25
END

IF ~~ THEN BEGIN 50 // from:
  SAY @88
  IF ~~ THEN EXTERN ~KARLATNW~ 29
END

IF ~~ THEN BEGIN 51 // from:
  SAY  @89
  IF ~  InMyArea("Belial")
~ THEN EXTERN ~BELIAL~ 26
  IF ~  !InMyArea("Belial")
~ THEN GOTO 52
END
...
~ THEN BEGIN 53 // from:
  SAY @91
  IF ~~ THEN EXTERN ~BELIAL~ 20
END

IF ~~ THEN BEGIN 54 // from:
  SAY @92
  IF ~~ THEN REPLY @93 EXTERN ~BELIAL~ 21
  IF ~~ THEN REPLY @94 EXTERN ~BELIAL~ 22
END
...
IF ~~ THEN BEGIN 62 // from: 59.1 58.1
  SAY @103
  IF ~~ THEN DO ~SetGlobal("JaregQuest","GLOBAL",5)
GiveItemCreate("PHYLACT3",Player1,1,0,0)
SetGlobal("Charwood_Is_Saved","GLOBAL",1)
ClearAllActions()
StartCutSceneMode()
StartCutScene("Court4")
~ EXIT
END
...
ClearAllActions()
StartCutSceneMode()
StartCutScene("Court5")
~ EXIT
END

IF ~~ THEN BEGIN 64 // from: 59.0 58.0
  SAY @87
  IF ~~ THEN EXTERN ~QUINTNW2~ 26
END

IF ~~ THEN BEGIN 65 // from:
  SAY @88
  IF ~~ THEN EXTERN ~KARLATNW~ 30
END

IF ~~ THEN BEGIN 66 // from:
  SAY @89
  IF ~  InMyArea("Belial")
~ THEN EXTERN ~BELIAL~ 23
  IF ~  !InMyArea("Belial")
~ THEN GOTO 67
END
...
IF ~~ THEN BEGIN 69 // from: 61.0 60.0
  SAY @87
  IF ~~ THEN EXTERN ~QUINTNW2~ 27
END

IF ~~ THEN BEGIN 70 // from:
  SAY @88
  IF ~~ THEN EXTERN ~KARLATNW~ 31
END

IF ~~ THEN BEGIN 71 // from:
  SAY @89
  IF ~  InMyArea("Belial")
~ THEN EXTERN ~BELIAL~ 24
  IF ~  !InMyArea("Belial")
~ THEN GOTO 72
END
...
ClearAllActions()
StartCutSceneMode()
StartCutScene("Court6")
~ EXIT
END

IF ~~ THEN BEGIN 79 // from: 77.0 76.0 75.0 74.0
  SAY @87
  IF ~~ THEN EXTERN ~QUINTNW2~ 30
END

IF ~~ THEN BEGIN 80 // from:
  SAY @88
  IF ~~ THEN EXTERN ~KARLATNW~ 32
END

IF ~~ THEN BEGIN 81 // from:
  SAY @89
  IF ~  InMyArea("Belial")
~ THEN EXTERN ~BELIAL~ 25
  IF ~  !InMyArea("Belial")
~ THEN GOTO 82
END
