...
~  Global("NWGoblinQuest","GLOBAL",1)~ THEN BEGIN 9 // from:
  ...
  IF ~  PartyHasItem("NWHEADOC")~ THEN REPLY @22 GOTO 12
...
IF ~~ THEN BEGIN 17 // from: 11.2
  SAY @30
  IF ~~ THEN DO ~SetGlobal("BugbeerDead","LOCALS",1)GiveGoldForce(1200)TakePartyItem("NWHEADBB")~ EXIT
END
...
IF ~~ THEN BEGIN 19 // from: 12.2
  SAY @30
  IF ~~ THEN DO ~SetGlobal("OrcDead","LOCALS",1)GiveGoldForce(1200)TakePartyItem("NWHEADOC")~ EXIT
END
