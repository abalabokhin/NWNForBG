...
IF ~~ THEN BEGIN 1 // from: 0.1
  SAY @2
  IF ~  PartyHasItem("AmulNeu")~ THEN REPLY @3 GOTO 2
  IF ~~ THEN REPLY @4 GOTO 3
  IF ~  GlobalGT("NeurikQuest","GLOBAL",0)~ THEN REPLY @5 GOTO 4
  IF ~  !PartyHasItem("AmulNeu")~ THEN REPLY @6 GOTO 5
...
~  Global("Pause","LOCALS",1)~ THEN BEGIN 19 // from:
  SAY @35
  IF ~  PartyHasItem("AmulNeu")~ THEN REPLY @36 GOTO 2
  IF ~  !PartyHasItem("AmulNeu")~ THEN REPLY @37 GOTO 5
