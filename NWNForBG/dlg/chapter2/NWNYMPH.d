...
~  NumTimesTalkedTo(0)Global("NWSHARM","LOCALS",0)~ THEN BEGIN 0 // from:
  SAY @0
  IF ~~ THEN DO ~SetGlobal("NWSHARM","LOCALS",1)ClearAllActions()StartCutSceneMode()StartCutScene("NWSHARM")~ EXIT
END

IF WEIGHT #1 /* Triggers after states #: 9 even though they appear after this state */
~  Global("NWSHARM","LOCALS",1)Global("KnowNymph","LOCALS",0)~ THEN BEGIN 1 // from:
  SAY @1
  IF ~~ THEN REPLY @2 DO ~SetGlobal("NWSHARM","LOCALS",2)~ GOTO 2
  IF ~~ THEN REPLY @3 DO ~SetGlobal("NWSHARM","LOCALS",2)~ GOTO 3
  IF ~~ THEN REPLY @4 DO ~SetGlobal("NWSHARM","LOCALS",2)~ GOTO 4
  IF ~~ THEN REPLY @5 DO ~SetGlobal("NWSHARM","LOCALS",2)~ GOTO 5
END
...
IF ~~ THEN BEGIN 8 // from: 4.2
  SAY @24
  IF ~~ THEN DO ~Enemy()ClearAllActions()StartCutSceneMode()StartCutScene("NWNYMPHM")~ EXIT
END
...
~  Global("KnowNymph","LOCALS",1)Dead("NWSPIRIO")~ THEN BEGIN 45 // from:
  SAY @95
