...
OR(3)!PartyHasItem("Vgem")!PartyHasItem("Zgem")!PartyHasItem("Sgem")~ THEN REPLY @75 GOTO 40
  IF ~  Global("AelaithQuest","GLOBAL",1)
PartyHasItem("Vgem")PartyHasItem("Zgem")PartyHasItem("Sgem")~ THEN REPLY @76 GOTO 54
  IF ~  Global("AelaithQuest","GLOBAL",3)
OR(3)PartyHasItem("Vgem")PartyHasItem("Zgem")PartyHasItem("Sgem")~ THEN REPLY @77 GOTO 41
  IF ~  Global("AelaithStore","LOCALS",1)~ THEN REPLY @71 GOTO 26
...
IF ~~ THEN BEGIN 40 // from: 39.2
  SAY @80
  IF ~  PartyHasItem("Vgem")~ THEN REPLY @81 GOTO 43
  IF ~  PartyHasItem("Zgem")~ THEN REPLY @82 GOTO 44
  IF ~  PartyHasItem("Sgem")~ THEN REPLY @83 GOTO 45
END
