...
PartyHasItem("CharwJ")
PartyHasItem("WardokL")~ THEN REPLY @9 GOTO 6
...
!PartyHasItem("RelmarL")
!PartyHasItem("CharwJ")
!PartyHasItem("WardokL")~ THEN REPLY @31 EXIT
END
...
IncrementGlobal("Evidence","GLOBAL",1)AddexperienceParty(20000)~ GOTO 18
  IF ~  PartyHasItem("NevaL")~ THEN REPLY @27 DO ~TakePartyItem("NevaL")
IncrementGlobal("Evidence","GLOBAL",1)AddexperienceParty(20000)~ GOTO 19
  IF ~  PartyHasItem("RelmarL")Global("WardokLetter","GLOBAL",0)~ THEN REPLY @28 DO ~TakePartyItem("RelmarL")
IncrementGlobal("Evidence","GLOBAL",1)SetGlobal("RelmarJournal","GLOBAL",1)AddexperienceParty(20000)~ GOTO 20
  IF ~  PartyHasItem("RelmarL")Global("WardokLetter","GLOBAL",1)~ THEN REPLY @28 DO ~TakePartyItem("RelmarL")
IncrementGlobal("Evidence","GLOBAL",1)SetGlobal("RelmarJournal","GLOBAL",1)~ GOTO 23
  IF ~  PartyHasItem("CharwJ")~ THEN REPLY @29 DO ~TakePartyItem("CharwJ")
IncrementGlobal("Evidence","GLOBAL",1)AddexperienceParty(20000)~ GOTO 21
  IF ~  PartyHasItem("WardokL")Global("RelmarJournal","GLOBAL",0)~ THEN REPLY @30 DO ~TakePartyItem("WardokL")
