...
~  !PartyHasItem("NWURTRIG")Global("NWUrtIsSaved","GLOBAL",0)!Dead("NWURT")~ THEN BEGIN 0 // from:
  SAY @0
  IF ~~ THEN EXIT
END
...
IF ~~ THEN BEGIN 3 // from: 2.1
  SAY @6
  IF ~~ THEN DO ~SetGlobal("NWUrtGold","GLOBAL",1)GiveGoldForce(500)~ EXIT
END

IF ~~ THEN BEGIN 4 // from: 2.2
  SAY @7
  IF ~~ THEN DO ~SetGlobal("NWUrtGold","GLOBAL",1)GiveGoldForce(700)~ EXIT
END
...
IF ~~ THEN BEGIN 6 // from: 2.4
  SAY @10
  IF ~~ THEN DO ~SetGlobal("NWUrtGold","GLOBAL",2)GiveGoldForce(1000)ReputationInc(-1)~ EXIT
END

IF WEIGHT #3 /* Triggers after states #: 9 even though they appear after this state */
~  Global("NWUrtGold","GLOBAL",1)~ THEN BEGIN 7 // from:
  SAY @11
  IF ~~ THEN EXIT
END
