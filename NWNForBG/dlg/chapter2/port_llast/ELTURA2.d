...
IF ~~ THEN BEGIN 3 // from: 0.3
  SAY @15
  IF ~  GlobalGT("CloakTower","GLOBAL",3)~ THEN DO ~  StartStore("ELTURA3",LastTalkedToBy(Myself))~ EXIT
  IF ~  GlobalLT("CloakTower","GLOBAL",4)~ THEN DO ~  StartStore("ELTURA2",LastTalkedToBy(Myself))~ EXIT
END
...
GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)GiveGoldForce(10000)AddexperienceParty(200000)EraseJournalEntry(@50)~ SOLVED_JOURNAL @37 EXIT
END
...
IF ~~ THEN BEGIN 36 // from: 35.1
  SAY @61
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK37")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(@50)~ SOLVED_JOURNAL @37 EXIT
END

IF ~~ THEN BEGIN 37 // from: 35.2
  SAY @62
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK34")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(@50)~ SOLVED_JOURNAL @37 EXIT
END

IF ~~ THEN BEGIN 38 // from: 35.3
  SAY @63
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK32")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(@50)~ SOLVED_JOURNAL @37 EXIT
END

IF ~~ THEN BEGIN 39 // from: 35.4
  SAY @64
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK36")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(@50)~ SOLVED_JOURNAL @37 EXIT
END

IF ~~ THEN BEGIN 40 // from: 35.5
  SAY @65
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK38")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(@50)~ SOLVED_JOURNAL @37 EXIT
END
