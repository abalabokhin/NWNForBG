...
~  Global("FarmerQuest","GLOBAL",2)Global("DergiabDone","LOCALS",0)Global("LeahDead","LOCALS",0)GlobalLT("LeahSaved","GLOBAL",2)~ THEN BEGIN 32 // from:
  SAY @61
  IF ~  PartyHasItem("HeadDerg")Global("DergiabDone","LOCALS",0)~ THEN REPLY @62 GOTO 33
  IF ~  Dead("Leah")PartyHasItem("LeahRing")Global("LeahDead","LOCALS",0)~ THEN REPLY @63 GOTO 34
  IF ~  OR(2)Global("LeahSaved","GLOBAL",1)InMyArea("Leah")GlobalLT("LeahSaved","GLOBAL",2)~ THEN REPLY @64 GOTO 35
...
~  Global("FarmerQuest","GLOBAL",2)Global("DergiabDone","LOCALS",1)Global("LeahDead","LOCALS",0)GlobalLT("LeahSaved","GLOBAL",2)~ THEN BEGIN 62 // from:
  SAY @97
  IF ~  Dead("Leah")PartyHasItem("LeahRing")Global("LeahDead","LOCALS",0)~ THEN REPLY @63 GOTO 34
  IF ~  OR(2)Global("LeahSaved","GLOBAL",1)InMyArea("Leah")GlobalLT("LeahSaved","GLOBAL",2)~ THEN REPLY @98 GOTO 35
  IF ~~ THEN REPLY @36 GOTO 36
  IF ~~ THEN REPLY @65 GOTO 37
  IF ~~ THEN REPLY @5 GOTO 38
END
