...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  !Dead("Zor")Global("KendrackQuest","GLOBAL",1)!Dead("Zamitra")Global("PlayerHasZgem","MYAREA",0)~ THEN REPLY @6 GOTO 5
  IF ~  !Dead("Zor")Global("KendrackQuest","GLOBAL",1)OR(2)Dead("Zamitra")Global("PlayerHasZgem","MYAREA",1)~ THEN REPLY @6 GOTO 6
  IF ~  !Dead("Zamitra")Global("PlayerHasZgem","MYAREA",0)OR(2)Dead("Zor")!Global("KendrackQuest","GLOBAL",1)~ THEN REPLY @6 GOTO 7
  IF ~  OR(2)Dead("Zor")!Global("KendrackQuest","GLOBAL",1)OR(2)Dead("Zamitra")Global("PlayerHasZgem","MYAREA",1)~ THEN REPLY @6 GOTO 8
