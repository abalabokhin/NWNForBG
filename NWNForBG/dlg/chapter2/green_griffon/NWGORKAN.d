...
~  NumTimesTalkedTo(0)GlobalLT("NWKnowsAboutMatch","GLOBAL",3)~ THEN BEGIN 0 // from:
  SAY @0
  IF ~  Global("NWKnowsAboutMatch","GLOBAL",0)~ THEN REPLY @1 GOTO 1
  IF ~  Global("NWKnowsAboutMatch","GLOBAL",0)~ THEN REPLY @2 GOTO 1
  IF ~  Global("NWKnowsAboutMatch","GLOBAL",1)~ THEN REPLY @2 GOTO 2
  IF ~~ THEN REPLY @3 GOTO 3
  IF ~  Global("NWKnowsAboutMatch","GLOBAL",1)~ THEN REPLY @4 GOTO 4
...
IF ~~ THEN BEGIN 6 // from: 1.1
  SAY @18
  IF ~~ THEN DO ~TakePartyGold(200)SetGlobal("NWKnowsAboutMatch","GLOBAL",1)~ GOTO 12
END
...
~  !NumTimesTalkedTo(0)Global("NWKnowsAboutMatch","GLOBAL",0)Global("Fail","LOCALS",0)~ THEN BEGIN 13 // from:
  SAY @25
...
~  !NumTimesTalkedTo(0)Global("NWKnowsAboutMatch","GLOBAL",0)Global("Fail","LOCALS",1)~ THEN BEGIN 13 // from:
  SAY @27
  IF ~~ THEN EXIT
END
...
~  !NumTimesTalkedTo(0)OR(2)Global("NWKnowsAboutMatch","GLOBAL",1)Global("NWKnowsAboutMatch","GLOBAL",2)~ THEN BEGIN 14 // from:
  SAY @28
  IF ~~ THEN EXIT
END
...
~  GlobalGT("NWKnowsAboutMatch","GLOBAL",2)~ THEN BEGIN 15 // from:
  SAY @29
