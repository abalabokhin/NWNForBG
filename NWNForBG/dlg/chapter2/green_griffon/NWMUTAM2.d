...
IF ~~ THEN BEGIN 13 // from: 4.2
  SAY @30
  IF ~~ THEN DO ~StartStore("NWMUTAMN",LastTalkedToBy(Myself))~ EXIT
END
...
IF ~~ THEN BEGIN 19 // from: NWZAMIT1 3
  SAY @37
  IF ~~ THEN EXTERN ~NWZAMIT1~ 3
END
...
IF ~~ THEN BEGIN 28 // from: 18.2
  SAY @49
  IF ~~ THEN DO ~StartStore("NWINNMUT",LastTalkedToBy(Myself))~ EXIT
END
