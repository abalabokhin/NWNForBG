...
IF ~~ THEN BEGIN 6 // from: 4.2
  SAY @13
  IF ~~ THEN DO ~SetGlobal("Attack","LOCALS",3)SetGlobal("ZamitraGem","MYAREA",1)ForceSpellRES("NWZAMITA",Myself)~ EXIT
END
...
IF ~~ THEN BEGIN 9 // from: 5.2
  SAY @18
  IF ~~ THEN DO ~SetGlobal("ZamitraGem","MYAREA",1)SetGlobal("Attack","LOCALS",3)ForceSpellRES("NWZAMITA",Myself)~ EXIT
END
...
IF ~~ THEN BEGIN 11 // from: 8.2
  SAY @20
  IF ~~ THEN REPLY @21 DO ~SetGlobal("ZamitraGem","MYAREA",1)SetGlobal("Attack","LOCALS",3)ForceSpellRES("NWZAMITA",Myself)~ EXIT
  IF ~~ THEN REPLY @12 GOTO 7
END
