...
~  NumTimesTalkedTo(0)Global("Dialogue","LOCALS",0)~ THEN BEGIN 0 // from:
  ...
  IF ~  PartyHasItem("AmulNeu")~ THEN REPLY @3 GOTO 3
  IF ~  !PartyHasItem("AmulNeu")~ THEN REPLY @4 GOTO 4
END
...
~  Global("NeurikQuest","GLOBAL",4)Global("Pause","LOCALS",1)~ THEN BEGIN 15 // from:
  ...
  IF ~  PartyHasItem("AmulNeu")~ THEN REPLY @3 DO ~SetGlobal("Pause","LOCALS",0)~  GOTO 3
  IF ~  !PartyHasItem("AmulNeu")~ THEN REPLY @4 GOTO 4
END
