...
IF ~~ THEN BEGIN 21 // from: 20.1
  SAY @47
  IF ~~ THEN DO ~SetGlobal("Pause","LOCALS",0)SetGlobal("CaretakerQuest","LOCALS",1)TakePartyGold(500)GiveItem("NWCRYPTY",LastTalkedToBy)~ EXIT
END

IF ~~ THEN BEGIN 22 // from: 20.2
  SAY @48
  IF ~~ THEN DO ~SetGlobal("CaretakerQuest","LOCALS",1)TakePartyGold(250)GiveItem("NWCRYPTY",LastTalkedToBy)~ EXIT
END
...
IF ~~ THEN BEGIN 27 // from: 24.2
  SAY @56
  IF ~~ THEN DO ~SetGlobal("CaretakerQuest","LOCALS",1)GiveItem("NWCRYPTY",LastTalkedToBy)~ EXIT
END
