...
~  Global("NWSriritPortal","GLOBAL",0)PartyHasItem("NWRITDA2")~ THEN BEGIN 0 // from:
  SAY @0
...
IF ~~ THEN BEGIN 4 // from: 3.1 3.2
  SAY @11
  IF ~~ THEN DO ~TakePartyItem("NWRITDA2")SetGlobal("NWSriritPortal","GLOBAL",1)ClearAllActions()StartCutSceneMode()StartCutScene("NWTOSRIT")~ EXIT
END
...
~  GlobalGT("NWSriritPortal","GLOBAL",0)~ THEN BEGIN 6 // from:
  SAY @13
  IF ~~ THEN DO ~DestroySelf()~ EXIT
END
