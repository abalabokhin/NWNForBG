...
IF ~~ THEN BEGIN 1 // from: 0.1
  SAY @4
  IF ~  Global("SpiritSaved","GLOBAL",1)~ THEN REPLY @5 GOTO 4
  IF ~  Dead("NWSPIRIO")~ THEN REPLY @5 GOTO 5
  IF ~  Global("SpiritSaved","GLOBAL",0)!Dead("NWSPIRIO")~ THEN REPLY @5 GOTO 6
...
~  GlobalGT("AavillQuest","GLOBAL",0)Global("SpiritSaved","GLOBAL",0)!Dead("NWSPIRIO")~ THEN BEGIN 14 // from:
  SAY @26
  IF ~~ THEN EXIT
END
