...
~  NumTimesTalkedTo(0)CheckStatLT(LastTalkedToBy,14,CHR)!Dead("NWBRAZI3")~ THEN BEGIN 0 // from:
  SAY @0
...
~  NumTimesTalkedTo(0)CheckStatGT(LastTalkedToBy,13,CHR)!Dead("NWBRAZI3")~ THEN BEGIN 41 // from:
  SAY @89
  IF ~~ THEN REPLY @1 GOTO 1
  IF ~~ THEN REPLY @2 GOTO 2
  IF ~~ THEN REPLY @3 GOTO 3
...
~  NumTimesTalkedTo(1)!Dead("NWBRAZI3")~ THEN BEGIN 42 // from:
  SAY @90
...
~  NumTimesTalkedToGT(1)!Dead("NWBRAZI3")~ THEN BEGIN 45 // from:
  SAY @96
  IF ~~ THEN EXIT
END
...
~  Dead("NWBRAZI3")~ THEN BEGIN 46 // from:
  SAY @97
  IF ~~ THEN GOTO 47
END
