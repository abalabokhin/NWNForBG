...
~  !NumTimesTalkedTo(0)Gender(LastTalkedToBy,FEMALE)Global("NWPlayerHasLuscanKey","GLOBAL",0)IsGabber(Player1)~ THEN BEGIN 35 // from:
  SAY @69
  IF ~~ THEN REPLY @70 GOTO 18
  IF ~~ THEN REPLY @71 GOTO 36
  IF ~  Dead("NWBARAM")Global("QuestDone","MYAREA",0)~ THEN REPLY @72 GOTO 37
  IF ~  Dead("NWKURT")Global("QuestDone","MYAREA",0)~ THEN REPLY @73 GOTO 38
END
...
IF ~~ THEN BEGIN 37 // from: 0.2
  SAY @75
  IF ~  Dead("NWKURT")~ THEN REPLY @76 GOTO 39
