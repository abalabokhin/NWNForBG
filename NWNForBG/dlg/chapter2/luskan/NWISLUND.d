...
IF ~~ THEN BEGIN 2 // from: 1.1
  SAY @7
  IF ~~ THEN DO ~SetGlobal("IslundPermission","MYAREA",1)TakePartyItem("NWPERMIO")Unlock("Door1")OpenDoor("Door1")~ EXIT
END
...
IF ~~ THEN BEGIN 8 // from: 2.2
  SAY @16
  IF ~~ THEN DO ~SetGlobal("IslundPermission","MYAREA",1)TakePartyItem("NWPERMIO")Unlock("Door1")OpenDoor("Door1")~ GOTO 11
END
