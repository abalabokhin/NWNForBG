...
IF ~~ THEN BEGIN 5 // from: 1.1
  SAY @13
  IF ~  Dead("NWEVAINE")~ THEN REPLY @14 GOTO 9
...
IF ~~ THEN BEGIN 26 // from: 22.5
  SAY @55
  IF ~  Dead("NWKURT")~ THEN REPLY @56 GOTO 32
  IF ~  Dead("NWKURT")~ THEN REPLY @57 GOTO 33
  IF ~  !Dead("NWKURT")~ THEN REPLY @58 GOTO 34
  IF ~  !Dead("NWKURT")~ THEN REPLY @59 GOTO 35
...
ReputationInc(1)ActionOverride("NWEVAINE",EscapeAreaObject("To2E00"))EscapeAreaObject("To2E00")~ SOLVED_JOURNAL @100877 EXIT
END
