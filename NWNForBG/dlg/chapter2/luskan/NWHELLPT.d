...
IF ~~ THEN BEGIN 5 // from: 1.5
  SAY @10
  IF ~~ THEN DO ~SetGlobal("QuasitEyeUsed","MYAREA",1)SetGlobal("HellPortalClosed","MYAREA",1)TakePartyItem("NWQUASGE")DestroyItem("NWQUASGE")~ EXIT
END
...
IF ~~ THEN BEGIN 7 // from: 1.7
  SAY @12
  IF ~~ THEN DO ~SetGlobal("ImpEyeUsed","MYAREA",1)SetGlobal("HellPortalClosed","MYAREA",1)TakePartyItem("NWIMPGOE")DestroyItem("NWIMPGOE")~ EXIT
END
