...
IF ~~ THEN BEGIN 8 // from: 6.1
  SAY @22
  IF ~~ THEN REPLY @23 DO ~SetGlobal("NWELYYD","GLOBAL",1)~ GOTO 15
...
IF ~~ THEN BEGIN 19 // 1500
  SAY @22
  IF ~~ THEN REPLY @23 DO ~SetGlobal("NWELYYD","GLOBAL",1)~ GOTO 38
...
IF ~~ THEN BEGIN 25 // from: 0.2
  SAY @22
  IF ~~ THEN REPLY @23 DO ~SetGlobal("NWELYYD","GLOBAL",1)~ GOTO 52
...
IF ~~ THEN BEGIN 38 // 1500
  SAY @44
  IF ~~ THEN REPLY @26 GOTO 42
  IF ~  Dead("NWBARAM")~ THEN REPLY @3 GOTO 20
  IF ~~ THEN REPLY @30 GOTO 45
...
IF ~~ THEN BEGIN 44 // 1500
  SAY @22
  IF ~~ THEN REPLY @23 DO ~SetGlobal("NWELYYD","GLOBAL",1)~ GOTO 68
...
IF ~~ THEN BEGIN 78 //
  SAY @22
  IF ~~ THEN REPLY @23 DO ~SetGlobal("NWELYYD","GLOBAL",1)~ GOTO 85
