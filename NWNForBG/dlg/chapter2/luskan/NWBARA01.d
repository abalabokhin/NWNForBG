...
~  RandomNum(5,1)Dead("NWBARAM")~ THEN BEGIN 0 // from:
  SAY @0
  IF ~~ THEN EXIT
END
...
~  RandomNum(5,2)Dead("NWBARAM")~ THEN BEGIN 4 // from:
  SAY @4
  IF ~~ THEN EXIT
END
...
~  RandomNum(5,3)Dead("NWBARAM")~ THEN BEGIN 8 // from:
  SAY @8
  IF ~~ THEN EXIT
END
...
~  RandomNum(5,4)Dead("NWBARAM")~ THEN BEGIN 12 // from:
  SAY @12
  IF ~~ THEN EXIT
END
