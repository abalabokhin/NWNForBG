...
~   NumTimesTalkedTo(0)Gender(LastTalkedToBy,MALE)~ THEN BEGIN 0 // from:
  ...
  IF ~  Global("ErikQuest","GLOBAL",1)~ THEN REPLY @3 GOTO 3
  IF ~  !Global("ErikQuest","GLOBAL",1)~ THEN REPLY @3 GOTO 11
END

IF ~~ THEN BEGIN 1 // from: 0.1
  SAY @4
  IF ~  Global("KnowAboutErik","GLOBAL",1)Global("ErikQuest","GLOBAL",0)~ THEN REPLY @5 GOTO 4
...
IF ~~ THEN BEGIN 2 // from: 0.2
  ...
  IF ~  Global("ErikQuest","GLOBAL",1)~ THEN REPLY @9 GOTO 7
  IF ~~ THEN REPLY @10 GOTO 8
  IF ~  Global("ErikQuest","GLOBAL",0)~ THEN REPLY @11 DO ~SetGlobal("MyOuest","LOCALS",1)~ GOTO 9
...
IF ~~ THEN BEGIN 7 // from: 2.2
  SAY @17
 IF ~  Global("ErikQuest","GLOBAL",1)PartyHasItem("NWMisc01")~ THEN REPLY @18 GOTO 34
...
IF ~~ THEN BEGIN 34 // from: 33.1
  ...
  IF ~  OR(2)Global("PriceL","GLOBAL",1)Dead("NWCONSTC")~ THEN GOTO 37
END
