...
IF ~~ THEN BEGIN 10 // from: 7.1
  SAY @24
  IF ~~ THEN DO ~SetGlobal("NWCoverlet","GLOBAL",1)GiveItemCreate("NWCOVERT",LastTalkedToBy,0,0,0)~ UNSOLVED_JOURNAL @107585 EXIT
END
...
~  Global("NWCoverlet","GLOBAL",1)PartyHasItem("NWCOVERT")Global("NW_Medicine","GLOBAL",0)~ THEN BEGIN 12 // from:
  SAY @27
  IF ~~ THEN GOTO 13
END
...
GiveItemCreate("NWMISC37",LastTalkedToBy,1,1,1)AddexperienceParty(84000)EraseJournalEntry(@107585)EraseJournalEntry(@107586)~ SOLVED_JOURNAL @107743 EXIT
END
