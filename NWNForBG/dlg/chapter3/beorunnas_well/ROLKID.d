...
IF ~~ THEN BEGIN 8 // from: 3.2
  ...
  IF ~  OR(2)PartyHasItem("ObolHead")PartyHasItem("ObolHea2")~ THEN REPLY @17 GOTO 12
  IF ~~ THEN REPLY @5 GOTO 4
  IF ~~ THEN REPLY @7 GOTO 6
END
...
IF ~~ THEN BEGIN 14 // from: 10.1
  ...
  IF ~  OR(2)PartyHasItem("GuzuHead")PartyHasItem("GuzudHd2")OR(2)PartyHasItem("VaatHead")PartyHasItem("VAATHEA2")Global("RolkidQuest","GLOBAL",1)~ THEN REPLY @28 GOTO 18
  IF ~~ THEN REPLY @5 GOTO 4
  IF ~~ THEN REPLY @7 GOTO 6
END
...
~  GlobalGT("RolkidQuest","GLOBAL",0)GlobalLT("RolkidQuest","GLOBAL",4)~ THEN BEGIN 21 // from:
  SAY @39
  IF ~  OR(2)PartyHasItem("ObolHead")PartyHasItem("ObolHea2")Global("RolkidQuest","GLOBAL",3)~ THEN REPLY @17 GOTO 12
  IF ~  OR(2)PartyHasItem("GuzuHead")PartyHasItem("GuzudHd2")OR(2)PartyHasItem("VaatHead")PartyHasItem("VAATHEA2")Global("RolkidQuest","GLOBAL",1)~ THEN REPLY @28 GOTO 18
