...
~  Global("Promise","LOCALS",0)Global("Broken","LOCALS",0)GlobalLT("NWRolgansTrial","GLOBAL",2)~ THEN BEGIN 0 // from:
  SAY @0
  IF ~  Global("NWRolganConvicted","GLOBAL",0)Global("NWRolganAcquitted","GLOBAL",0)~ THEN REPLY @1 GOTO 1
  IF ~  GlobalGT("NWRolganAcquitted","GLOBAL",0)~ THEN REPLY @1 GOTO 2
  IF ~  GlobalGT("NWRolganConvicted","GLOBAL",0)~ THEN REPLY @1 GOTO 3
  IF ~~ THEN REPLY @2 GOTO 4
  IF ~  GlobalGT("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 5
  IF ~  Global("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 6
...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  Global("NWRolgansTrial","GLOBAL",1)~ THEN REPLY @9 GOTO 12
  IF ~  GlobalGT("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 5
  IF ~  Global("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 6
  IF ~~ THEN REPLY @4 GOTO 7
  IF ~~ THEN REPLY @6 GOTO 10
...
IF ~~ THEN BEGIN 2 // from: 0.2
  SAY @10
  IF ~  Global("NWRolganConvicted","GLOBAL",0)Global("NWRolganAcquitted","GLOBAL",0)~ THEN REPLY @2 GOTO 4
  IF ~  GlobalGT("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 5
  IF ~  Global("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 6
  IF ~~ THEN REPLY @4 GOTO 7
  IF ~~ THEN REPLY @6 GOTO 10
...
IF ~~ THEN BEGIN 4 // from: 0.4
  SAY @12
  IF ~  Global("NWRolganConvicted","GLOBAL",0)Global("NWRolganAcquitted","GLOBAL",0)~ THEN GOTO 13
  IF ~  OR(2)GlobalGT("NWRolganConvicted","GLOBAL",0)GlobalGT("NWRolganAcquitted","GLOBAL",0)~ THEN GOTO 14
END
...
IF ~~ THEN BEGIN 15 // from: 7.1
  ...
  IF ~  GlobalGT("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 5
  IF ~  Global("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 6
  IF ~  Global("NWRolganConvicted","GLOBAL",0)Global("NWRolganAcquitted","GLOBAL",0)~ THEN REPLY @30 GOTO 4
  IF ~~ THEN REPLY @6 GOTO 10
END
...
~  Global("Broken","LOCALS",0)GlobalGT("NWRolganAcquitted","GLOBAL",0)~ THEN BEGIN 22 // from:
  SAY @36
  IF ~  GlobalGT("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 5
  IF ~  Global("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 6
  IF ~~ THEN REPLY @4 GOTO 7
...
~  GlobalGT("NWRolganConvicted","GLOBAL",0)Global("Broken","LOCALS",0)~ THEN BEGIN 23 // from:
  SAY @37
  IF ~~ THEN GOTO 24
END
...
~  Global("Promise","LOCALS",1)Global("Broken","LOCALS",0)Global("NWRolgansTrial","GLOBAL",1)~ THEN BEGIN 25 // from:
  SAY @39
  IF ~  GlobalGT("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 5
  IF ~  Global("NWILCARD_Free","GLOBAL",0)~ THEN REPLY @3 GOTO 6
  IF ~~ THEN REPLY @4 GOTO 7
