...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  Global("MyBook","LOCALS",0)~ THEN REPLY @9 DO ~SetGlobal("MyBook","LOCALS",1)GiveItemCreate("Barubook",LastTalkedToBy,0,0,0)~ GOTO 5
...
IF ~~ THEN BEGIN 7 // from: 1.1
  SAY @16
  IF ~  PartyHasItem("Plat04")PartyHasItem("Rithtel2")~ THEN REPLY @17 GOTO 35
  IF ~  PartyHasItem("Chan02")PartyHasItem("Holywanw")~ THEN REPLY @18 GOTO 35
  IF ~  PartyHasItem("Leat07")PartyHasItem("GarSkull")~ THEN REPLY @19 GOTO 35
  IF ~  PartyHasItem("AX1H02")PartyHasItem("Adamant")~ THEN REPLY @20 GOTO 35
  IF ~  PartyHasItem("Halb02")PartyHasItem("Adamant")~ THEN REPLY @21 GOTO 35
  IF ~   PartyHasItem("AX1H02")PartyHasItem("Drablood")~ THEN REPLY @22 GOTO 35
  IF ~~ THEN REPLY @23 EXIT
END

IF ~~ THEN BEGIN 8 // from: 1.2
  SAY @24
  IF ~  PartyHasItem("Blun01")PartyHasItem("Ironwood")~ THEN REPLY @25 GOTO 35
  IF ~  PartyHasItem("Blun05")PartyHasItem("Ironwood")~ THEN REPLY @26 GOTO 35
  IF ~  PartyHasItem("HAMM02")PartyHasItem("Rithtel2")~ THEN REPLY @27 GOTO 35
  IF ~  PartyHasItem("Blun03")PartyHasItem("Ironwood")~ THEN REPLY @28 GOTO 35
  IF ~  PartyHasItem("Blun05")PartyHasItem("Holywanw")~ THEN REPLY @29 GOTO 35
  IF ~   PartyHasItem("Blun07")PartyHasItem("Magdust")~ THEN REPLY @30 GOTO 35
  IF ~  PartyHasItem("Hamm03")PartyHasItem("Adamant")~ THEN REPLY @31 GOTO 35
  IF ~~ THEN REPLY @23 EXIT
END

IF ~~ THEN BEGIN 9 // from: 1.3
  SAY @32
  IF ~  PartyHasItem("Sw2h02")PartyHasItem("Adamant")~ THEN REPLY @33 GOTO 35
  IF ~  PartyHasItem("Sw1h44")PartyHasItem("Adamant")~ THEN REPLY @34 GOTO 35
  IF ~  PartyHasItem("Sw1h05")PartyHasItem("Rithtel2")~ THEN REPLY @35 GOTO 35
  IF ~  PartyHasItem("Sw1h02")PartyHasItem("Rithtel2")~ THEN REPLY @36 GOTO 35
  IF ~  PartyHasItem("Sw1h022")PartyHasItem("Adamant")~ THEN REPLY @37 GOTO 35
  IF ~   PartyHasItem("Sw1h008")PartyHasItem("Magdust")~ THEN REPLY @38 GOTO 35
  IF ~~ THEN REPLY @23 EXIT
END

IF ~~ THEN BEGIN 10 // from: 1.4
  SAY @39
  IF ~  PartyHasItem("Halb03")PartyHasItem("Drablood")~ THEN REPLY @40 GOTO 35
  IF ~   PartyHasItem("SPER02")PartyHasItem("Magdust")~ THEN REPLY @41 GOTO 35
  IF ~~ THEN REPLY @23 EXIT
END
