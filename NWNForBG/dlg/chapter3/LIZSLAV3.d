...
~  HasItemEquiped("Translat",LastTalkedToBy(Myself))Global("Golem3_Afraid_of_Fire","GLOBAL",1)~ THEN BEGIN 25 // from:
  SAY @44
...
~  HasItemEquiped("Translat",LastTalkedToBy(Myself))Global("Golem3_Afraid_of_Cold","GLOBAL",1)~ THEN BEGIN 29 // from:
  SAY @49
...
~  HasItemEquiped("Translat",LastTalkedToBy(Myself))Global("Golem3_Afraid_of_Crushing","GLOBAL",1)~ THEN BEGIN 33 // from:
  SAY @51
...
~  HasItemEquiped("Translat",LastTalkedToBy(Myself))Global("Golem3_Afraid_of_Slashing","GLOBAL",1)~ THEN BEGIN 37 // from:
  SAY @52
