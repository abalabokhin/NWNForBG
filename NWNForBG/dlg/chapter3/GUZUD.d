...
IF ~~ THEN BEGIN 1 // from: 0.1
  ...
  IF ~  !Dead("Vaath")~ THEN REPLY @6 GOTO 5
  IF ~  Dead("Vaath")~ THEN REPLY @7 GOTO 6
END
...
IF ~~ THEN BEGIN 3 // from: 1.1  С головой
  ...
  IF ~  !Dead("Vaath")~ THEN REPLY @6 GOTO 9
...
IF ~~ THEN BEGIN 4 // from: 1.2 С золотом
  ...
  IF ~  !Dead("Vaath")~ THEN REPLY @6 GOTO 13
  IF ~~ THEN REPLY @11 GOTO 10
END
...
IF ~~ THEN BEGIN 8 // from: 3.2 с головой и с золотом
  ...
  IF ~  !Dead("Vaath")~ THEN REPLY @6 GOTO 15
  IF ~~ THEN REPLY @11 GOTO 10
END
