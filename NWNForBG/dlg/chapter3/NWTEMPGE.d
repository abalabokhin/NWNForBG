...
~  HasItemEquiped("NWTRANST",LastTalkedToBy(Myself))Global("TempGolemTalk","LOCALS",0)~ THEN BEGIN 2 // from:
  SAY @5
...
~  HasItemEquiped("NWTRANST",LastTalkedToBy(Myself))GlobalGT("TempGolemTalk","LOCALS",0)~ THEN BEGIN 12 // from:
  SAY @23
