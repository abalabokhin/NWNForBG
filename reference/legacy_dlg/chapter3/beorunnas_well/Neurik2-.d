...
IF ~~ THEN BEGIN 23 // from: 21.1
  ...
  IF ~  Global("RolganConvicted","GLOBAL",1)~ THEN GOTO 27
  IF ~  Global("RolganAcquitted","GLOBAL",1)~ THEN GOTO 28
END
...
IF ~~ THEN BEGIN 47 // from: IGLAND3 7.7
  ...
  IF ~  Global("Justification","GLOBAL",3)Global("ToAcquitted","GLOBAL",2)~ THEN GOTO 49
  IF ~  Global("Justification","GLOBAL",3)Global("ToAcquitted","GLOBAL",1)~ THEN GOTO 50
  ...
  IF ~  Global("Justification","GLOBAL",3)Global("ToAcquitted","GLOBAL",0)~ THEN GOTO 52
  IF ~  Global("Justification","GLOBAL",1)Global("ToAcquitted","GLOBAL",2)~ THEN GOTO 52
  IF ~  Global("ToAcquitted","GLOBAL",2)Global("JevonTalk","GLOBAL",0)~ THEN GOTO 54
  IF ~  Global("ToAcquitted","GLOBAL",1)Global("JevonTalk","GLOBAL",1)~ THEN GOTO 54
  IF ~  Global("ToAcquitted","GLOBAL",0)Global("JevonTalk","GLOBAL",2)~ THEN GOTO 54
  IF ~  Global("ToAcquitted","GLOBAL",0)Global("JevonTalk","GLOBAL",2)~ THEN GOTO 54
  IF ~  Global("ToAcquitted","GLOBAL",1)Global("JevonTalk","GLOBAL",1)~ THEN GOTO 54
  IF ~  Global("ToAcquitted","GLOBAL",2)Global("JevonTalk","GLOBAL",0)~ THEN GOTO 54
  IF ~  GlobalLT("ToAcquitted","GLOBAL",2)~ THEN GOTO 54
END
...
IF ~~ THEN BEGIN 49 // from: 47.1
  ...
  IF ~~ THEN DO ~SetGlobal("RolgansTrial","GLOBAL",5)SetGlobal("VandJob","GLOBAL",5)SetGlobal("RolganAcquitted","GLOBAL",1)AddexperienceParty(160000)~ EXIT
END
...
IF ~~ THEN BEGIN 51 // from: IGLAND3 14
  ...
  IF ~~ THEN DO ~SetGlobal("RolgansTrial","GLOBAL",5)SetGlobal("VandJob","GLOBAL",5)SetGlobal("RolganAcquitted","GLOBAL",1)AddexperienceParty(130000)~ EXIT
END
...
IF ~~ THEN BEGIN 53 // from: IGLAND3 15
  SAY ~Игланд, ты выполнил свою работу. Предлагаю тебе уйти, пока я не отметил где-нибудь твое отвратительное поведение во время этого заседания. Ты позоришь священные залы этого Храма! <CHARNAME>, приходи ко мне поговорить, когда захочешь поговорить.~
  IF ~~ THEN DO ~SetGlobal("RolgansTrial","GLOBAL",5)SetGlobal("VandJob","GLOBAL",5)SetGlobal("RolganAcquitted","GLOBAL",1)AddexperienceParty(100000)~ EXIT
END
...
IF ~~ THEN BEGIN 55 // from: IGLAND3 16
  SAY ~Игланд, ты выполнил свою работу. Предлагаю тебе уйти, пока я не отметил где-нибудь твое отвратительное поведение во время этого заседания. Ты позоришь священные залы этого Храма! <CHARNAME>, приходи ко мне поговорить, когда захочешь поговорить.~
  IF ~~ THEN DO ~SetGlobal("RolgansTrial","GLOBAL",5)SetGlobal("VandJob","GLOBAL",7)SetGlobal("RolganConvicted","GLOBAL",1)~ EXIT
END
