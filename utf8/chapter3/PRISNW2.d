...
IF ~~ THEN BEGIN 2 // from: 0.3
  SAY ~Я слышала, как мои тюремщики говорили о каком-то огненном великане, посланнике от Клаута, который предложил крупное вознаграждение за драконьи яйца, которые могут найти великаны холмов.~
...
IF ~~ THEN BEGIN 3 // from: 0.4
  SAY ~Я Утгардт, Дочь Орла, гордый воин. Я сама найду выход из этого места. А теперь мне пора воссоединиться с мои народом. Прощайте, и пусть парящий орел наблюдает за вами.~
  IF ~~ THEN DO ~AddexperienceParty(30000)EscapeAreaDestroy(60)~ EXIT
END

IF ~~ THEN BEGIN 4 // from: 2.1
  SAY ~Этого я не знаю. Но прежде чем я попала в плен, я слышала слухи о том, что банды великанов холмов нападают на гнезда драконов и воруют их яйца. Должно быть они собирали яйца для посланника Клаута.~
  IF ~~ THEN REPLY ~Клаут? Кто это?~ GOTO 5
  IF ~~ THEN REPLY ~Что там насчет посланника огненных великанов?~ GOTO 6
...
IF ~~ THEN BEGIN 6 // from: 2.3
  SAY ~Я слышала, как мои тюремщики говорили о посланнике огненных великанов, который служит Клауту и остановился в селении великанов холмов. Это он доставил сюда послание Клаута с приказанием переправить ему не проклюнувшиеся драконьи яйца.~
  IF ~~ THEN REPLY ~Зачем им нужны драконьи яйца?~ GOTO 4
  IF ~~ THEN REPLY ~Клаут? Кто это?~ GOTO 5
  IF ~~ THEN REPLY ~А вы-то, собственно, кто? И почему великаны холмов вас захватили?~ GOTO 1
  IF ~~ THEN REPLY ~Мне уже пора идти. Вы сможете сами выбраться отсюда?~ GOTO 3
