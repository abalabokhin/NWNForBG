...
~  OR(2)Global("ElturaQuest","GLOBAL",0)Global("ElturaQuest","GLOBAL",6)~ THEN BEGIN 0 // from:
  SAY ~Добро пожаловать. Я Эльтура Сарптил, и вряд ли вы найдете у кого-то еще такой прекрасный выбор товаров.~ [ELTUR055]
...
PartyHasItem("NWBOOK32")
PartyHasItem("NWBOOK36")
PartyHasItem("NWBOOK38")~ THEN REPLY ~У меня есть одна из книг, которые вы ищете.~ GOTO 35
...
PartyHasItem("NWBOOK38")~ THEN REPLY ~У меня есть все книги, которые вы ищете.~ GOTO 15
  IF ~~ THEN REPLY ~Какие товары вы продаете?~ GOTO 2
...
IF ~~ THEN BEGIN 4 // from: 0.4
  ...
  IF ~  GlobalGT("ElturaQuest","GLOBAL",0)GlobalLT("ElturaQuest","GLOBAL",6)~ THEN REPLY ~Можете мне напомнить об этой работе по поиску книг?~ GOTO 19
  IF ~~ THEN REPLY ~Могу я посмотреть ваши товары?~ GOTO 3
  IF ~~ THEN REPLY ~До свидания.~ GOTO 5
END
...
IF ~~ THEN BEGIN 6 // from: 1.1
  SAY ~Ах, Том Огня! Это будет прекрасное дополнение к моей коллекции. Спасибо вам большое, а теперь поговорим о награде. Вот ваши 2000 золотых, как и договаривались.~
...
IF ~~ THEN BEGIN 7 // from: 1.2
  SAY ~Ага, Том Льда. Еще одна прекрасная работа пополнит мое собрание. Спасибо вам за это. А теперь поговорим о награде. Вот ваши 2000 золотых, как и договаривались.~
...
IF ~~ THEN BEGIN 8 // from: 1.3
  SAY ~О, вот эту восхитительную книгу я с удовольствием просмотрю, полагаю. Вот это меня по-настоящему радует. А для вас.... Вот ваши 2000 золотых, как и договаривались.~
...
IF ~~ THEN BEGIN 9 // from: 1.4
  SAY ~Ах, какая исключительная книга. Я всегда думала, что смерть - это такая чудная, недопонятая вещь. Эта книга будет служить украшением моей коллекции. Я полагаю, вы этим будете вполне довольны наградой, вот ваши 2000 золотых, как и договаривались.~
...
IF ~~ THEN BEGIN 10 // from: 1.5
  SAY ~Так-так, Том Резонанса. Хоть я и надеялась на лучшее, но была уверена, что никогда ее не увижу в своей библиотеке. Выражаю вам свое восхищение - и признательность. Я полагаю, вы будете вполне довольны наградой. Вот ваши 2000 золотых, как и договаривались.~
...
IF ~~ THEN BEGIN 15 // from: 0.2
  SAY ~Ах, неужели, как это замечательно! Ах, какие исключительные книги. Эти книги будет служить украшением моей коллекции. Я полагаю, вы будете вполне довольны наградой. Вот ваши 10000 золотых, и к ним я добавлю магический артефакт. Это очень редкая вещь.~
...
GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)GiveGoldForce(10000)AddexperienceParty(200000)EraseJournalEntry(%Порт-Лласт: Пять томов Имаскара

После того, как с Невервинтера был снят карантин, волшебница Эльтура направилась в Порт-Лласт, чтобы предложить свою помощь для поисков организаторов смуты из таинственной секты. Однако у нее были и личные мотивы, поскольку она разыскивала собрание древних книг погибшей цивилизации Имаскара. Утверждают, что в этих пяти томах содержатся рецепты, с помощью которых можно проводить некие магические эксперименты. Если ей удастся найти хотя бы некоторые из этих книг, она щедро вознаградит того, кто принесет их ей.

С помощью магии ясновидения ей удалось выяснить приблизительное местонахождение пяти томов Имаскара. По ее данным, Том Огня и Том Смерти затерялись где-то в Чарвуде, тогда как Том Жизни, очевидно, похоронен вместе с телом брата Тораса на кладбище за стенами Лускана. Том Льда находится в башне к югу от Порт-Лласта, а последняя книга, Том Резонанса, по всей видимости, где-то у опаснейшей дороги в глубине Леса Невервинтер.%)~ SOLVED_JOURNAL ~Порт-Лласт: Пять томов Имаскара

После того, как с Невервинтера был снят карантин, волшебница Эльтура направилась в Порт-Лласт, чтобы предложить свою помощь для поисков организаторов смуты из таинственной секты. Однако у нее были и личные мотивы, поскольку она разыскивала собрание древних книг погибшей цивилизации Имаскара. Утверждают, что в этих пяти томах содержатся рецепты, с помощью которых можно проводить некие магические эксперименты. Все пять книг были доставлены Эльтуре, награда получена. Она оказалась более чем достойной.~ EXIT
END
...
IF ~~ THEN BEGIN 17 // from: 13.1
  SAY ~Пять Томов Древнего Имаскара находятся где-то в этом районе в разрозненном виде. Я хочу, чтобы вы нашли эти тома и вернули их мне. Если вы сможете это сделать, я дам вам гораздо больше, чем стоят книги. Уж в этом вы можете быть уверены. Пять книг, которые я прошу вас найти, это тома Резонанса, Жизни, Смерти, Льда и Огня. За каждую книгу я заплачу вам по 2000 золотых, а если принесете все пять книг, я добавлю к награде превосходный магический предмет.~
...
IF ~~ THEN BEGIN 20 // from: 17.6
  ...
  IF ~  Global("ElturaQuest","GLOBAL",0)~ THEN DO ~SetGlobal("ElturaQuest","GLOBAL",1)~ UNSOLVED_JOURNAL ~Порт-Лласт: Пять томов Имаскара

После того, как с Невервинтера был снят карантин, волшебница Эльтура направилась в Порт-Лласт, чтобы предложить свою помощь для поисков организаторов смуты из таинственной секты. Однако у нее были и личные мотивы, поскольку она разыскивала собрание древних книг погибшей цивилизации Имаскара. Утверждают, что в этих пяти томах содержатся рецепты, с помощью которых можно проводить некие магические эксперименты. Если ей удастся найти хотя бы некоторые из этих книг, она щедро вознаградит того, кто принесет их ей.

С помощью магии ясновидения ей удалось выяснить приблизительное местонахождение пяти томов Имаскара. По ее данным, Том Огня и Том Смерти затерялись где-то в Чарвуде, тогда как Том Жизни, очевидно, похоронен вместе с телом брата Тораса на кладбище за стенами Лускана. Том Льда находится в башне к югу от Порт-Лласта, а последняя книга, Том Резонанса, по всей видимости, где-то у опаснейшей дороги в глубине Леса Невервинтер.~ EXIT
...
IF ~~ THEN BEGIN 26 // from: 19.1
  ...
  IF ~~ THEN REPLY ~Вы знаете, где находится Том Резонанса?~ GOTO 30
  IF ~~ THEN REPLY ~Могу я посмотреть ваши товары?~ GOTO 3
  IF ~~ THEN REPLY ~Это все, что мне нужно было знать. До свидания.~ GOTO 5
END
...
IF ~~ THEN BEGIN 35 // from: 0.2
  SAY ~Ну что за великолепные новости. Пожалуйста, покажите мне, что у вас есть. О, все это так волнующе!~
  IF ~  PartyHasItem("NWBOOK37")~ THEN REPLY ~Предложить Том Огня.~ GOTO 36
  IF ~  PartyHasItem("NWBOOK34")~ THEN REPLY ~Предложить Том Льда.~ GOTO 37
  IF ~  PartyHasItem("NWBOOK32")~ THEN REPLY ~Предложить Том Жизни.~ GOTO 38
  IF ~  PartyHasItem("NWBOOK36")~ THEN REPLY ~Предложить Том Смерти.~ GOTO 39
  IF ~  PartyHasItem("NWBOOK38")~ THEN REPLY ~Предложить Том Резонанса.~ GOTO 40
  IF ~~ THEN REPLY ~Пока что я не буду расставаться с книгами.~ GOTO 11
END

IF ~~ THEN BEGIN 36 // from: 35.1
  SAY ~Ах, Том Огня! Это будет прекрасное дополнение к моей коллекции. Спасибо вам большое, теперь у меня есть все книги и можно поговорить о награде. Я полагаю, вы этим будете вполне довольны. Вот ваши 2000 золотых, и к ним я добавлю магический артефакт. Это очень редкая вещь.~
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK37")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(%Порт-Лласт: Пять томов Имаскара
...
IF ~~ THEN BEGIN 37 // from: 35.2
  SAY ~Ага, Том Льда. Еще одна прекрасная работа пополнит мое собрание. Спасибо вам за это, теперь у меня есть все книги и можно поговорить о награде. Я полагаю, вы этим будете вполне довольны. Вот ваши 2000 золотых, и к ним я добавлю магический артефакт. Это очень редкая вещь.~
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK34")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(%Порт-Лласт: Пять томов Имаскара
...
IF ~~ THEN BEGIN 38 // from: 35.3
  SAY ~О, вот эту восхитительную книгу я с удовольствием просмотрю, полагаю. Вот это меня по-настоящему радует. Теперь у меня есть все книги и можно поговорить о награде. Я полагаю, вы этим будете вполне довольны. Вот ваши 2000 золотых, и к ним я добавлю магический артефакт. Это очень редкая вещь.~
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK32")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(%Порт-Лласт: Пять томов Имаскара
...
IF ~~ THEN BEGIN 39 // from: 35.4
  SAY ~Ах, какая исключительная книга. Я всегда думала, что смерть - это такая чудная, недопонятая вещь. Эта книга будет служить украшением моей коллекции. Теперь у меня есть все книги и можно поговорить о награде. Я полагаю, вы этим будете вполне довольны. Вот ваши 2000 золотых, и к ним я добавлю магический артефакт. Это очень редкая вещь.~
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK36")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(%Порт-Лласт: Пять томов Имаскара
...
IF ~~ THEN BEGIN 40 // from: 35.5
  SAY ~Так-так, Том Резонанса. Хоть я и надеялась на лучшее, но была уверена, что никогда ее не увижу в своей библиотеке. Выражаю вам свое восхищение - и признательность. Теперь у меня есть все книги и можно поговорить о награде. Я полагаю, вы этим будете вполне довольны. Вот ваши 2000 золотых, и к ним я добавлю магический артефакт. Это очень редкая вещь.~
  IF ~~ THEN DO ~IncrementGlobal("ElturaQuest","GLOBAL",1)TakePartyItem("NWBOOK38")GiveGoldForce(2000)GiveItemCreate("ELTURITM",LastTalkedToBy,1,0,0)AddexperienceParty(40000)EraseJournalEntry(%Порт-Лласт: Пять томов Имаскара
...
~  GlobalGT("ElturaQuest","GLOBAL",0)GlobalLT("ElturaQuest","GLOBAL",6)~ THEN BEGIN 41 // from:
  ...
  IF ~~ THEN REPLY ~Что за волнующие новости я могу принести?~ GOTO 42
  IF ~  GlobalGT("ElturaQuest","GLOBAL",0)GlobalLT("ElturaQuest","GLOBAL",5)OR(5)
PartyHasItem("NWBOOK37")
PartyHasItem("NWBOOK34")
PartyHasItem("NWBOOK32")
